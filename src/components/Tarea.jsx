    ...
    return (
        <div className="border-b p-5 flex justify-between items-center">
            ...
            <div className="flex gap-4 flex-col lg:flex-row">
                ...
                <button className={`${estado ? 'bg-red-600 hover:bg-red-700' : 'bg-gray-600 hover:bg-gray-700'} px-4 py-3 text-white uppercase font-bold text-sm rounded-lg `} onClick={() => statusTarea(_id)}>{estado ? 'Completa' : 'Incompleta'}</button>
                {admin && (
