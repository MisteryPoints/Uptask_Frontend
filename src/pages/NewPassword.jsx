...
const NewPassword = () => {
  ...
  return ( 
    <>
      <h1 className="text-red-600 font-black text-6xl capitalize select-none">Reestablece tu Password y no pierdas acceso a tus <span className="text-slate-700">Proyectos</span></h1>
      ...
      <form className="my-10 p-10 bg-white shadow rounded-lg" onSubmit={handleSubmit}>
        ...
        <input type="submit" value="Reestablece tu Password" className="bg-red-700 w-full mb-5 py-3 text-white uppercase font-bold rounded-lg border cursor-pointer hover:bg-red-800 transition-all duration-300" />
      </form>
      )}
      { passwordModify && (
